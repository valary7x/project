...
public class GameManager : MonoBehaviour
{
    ...
    #region private GameObject CreateFrame()
    ...
    private GameObject CreateFrame()
    {
        ...
        //
        GameObject top = newFrame.gameObject.transform.GetChild(0).gameObject; //expensive method

        // Get the number of children of top. This is the number of sprites for the top part
        // of the frame. 
        //
        int numChildren = top.transform.childCount; //put numChildren to be local variable and then cache it. can do this because it is not changing
        ...
        for (int i = 0; i < numChildren; i++)
        {
            ...
            GameObject sprite = (GameObject)Instantiate(prefabs[randomIndex]); //not necessary to instantiate gameobject, just change the sprite
            ...
            //
            sprite.transform.parent = top.transform; // not necessary anymore if you change the sprite
            sprite.transform.position = pos; //not necessary anymore
        }
        ...
        // this code can remove if you remove the gameobject and just change the sprite
        ...
        //something somewhere here is hardcoded?? its just refactoring 
        ...
        //this whole loop might be unneccessary. see how can reuse the gameobject
        for (int i = 0; i < numChildren; i++)
        {
            GameObject sprite;
    ...
    #region private void MoveFrames()
    ...
    private void MoveFrames()
    {
        ...
        foreach (GameObject frame in frames)
        {
            ...
            //cache all this. it finds and sends back game component. might not use physics because physics is movement.
            //do calculation yourself
            //new is not necessary. just set the values
    ...
    #region float GetDistanceToNeighbour()
    ...
    float GetDistanceToNeighbour(GameObject frame)
    {
        ...
        //no need to use raycast. can just use array 
        ...
        else
        {
            ...
            //
            bool leftFrame = true;
            //refactor this. if the loop is necessary, once frame has been found, break out of the loop.
    ...
    #region private void CheckRespawnFrames()
    ...
    private void CheckRespawnFrames()
    {
        ...
        for(int i = frames.Count-1; i >= 0; i--)
        {
            ...
            // will be destroyed.
            //once you find that one frame, you can exit from the loop
            if(frame.transform.position.x < leftExtent)
            {
                ...
                //change the createframe() to something different so that it can be reused
                float gap = frameWidth * 0.1f;
    ...
    #region private GameObject CheckHitFrame()
    ...
    #region private void RotateSprites()
    ...
    private void RotateSprites()
    {
        ...
        //better to have another script. and too many calls in this function
        foreach(GameObject frame in frames)
        {
    ...
    #region private void UpdateTime()
    ...
    private void UpdateTime()
    {
        ...
        Debug.Log("time is updating");
    }
    #endregion

    #region private void UpdateScore()
    // Update the Score text in the UI
    private void UpdateScore()
    {
        scoreText.text = "Score: " + score;

        Debug.Log("score is updating");
    }
    #endregion

    #region private void ShowBackgroundCharacters()
    ...
    //preset an audioSource and call that preset value so that you don't need to delve into the files over and over again
        ...
        if(initialised)
        {
            ...
            if (hitFrame)
            {
                ...
                for (int i = 0; i < numChildren; i++)
                {
                    ...
                    //do some refactor here. this is hardcoding values
                ...
                // hitFrame.
                // this might be unecessary. break out of it early
                if (matched == true)
                {
                    ...
                    //stop and restart. don't create everytime. checkHitFrame has mouse position so just use that 
            ...
            // cache this and put in an array
